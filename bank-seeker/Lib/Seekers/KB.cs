            ...
            try
            {
                ...
                using (var bitmapKeypad = Bitmap.FromFile(keypadImagePath))
                {
                    ...
                    var solDigests = new Dictionary<string, Digest>() {
                        {"num5", ImagePhash.ComputeDigest(@"./KB_keypad_sol_5.bmp", SIGMA, GAMMA, DEGREE) },
                        {"num7", ImagePhash.ComputeDigest(@"./KB_keypad_sol_7.bmp", SIGMA, GAMMA, DEGREE) },
                        {"num8", ImagePhash.ComputeDigest(@"./KB_keypad_sol_8.bmp", SIGMA, GAMMA, DEGREE) },
                        {"num9", ImagePhash.ComputeDigest(@"./KB_keypad_sol_9.bmp", SIGMA, GAMMA, DEGREE) },
                        {"num0", ImagePhash.ComputeDigest(@"./KB_keypad_sol_0.bmp", SIGMA, GAMMA, DEGREE) },
                    };
